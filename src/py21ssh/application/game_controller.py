...
from py21ssh.conf import MIN_BET, STARTING_BALANCE
from py21ssh.domain.deck import Deck
from py21ssh.domain.interfaces import PlayerAction, RoundResult
...
if TYPE_CHECKING:
    ...
    from py21ssh.domain.interfaces import IGameRules
