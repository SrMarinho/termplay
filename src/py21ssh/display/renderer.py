...
from py21ssh.conf import CONSOLE_WIDTH, MIN_BET
from py21ssh.domain.card import Card
...
class RichRenderer:
    ...
    def __init__(self, width: int = _TERMINAL_WIDTH) -> None:
        self._width = width
    ...
    def welcome(self) -> str:
        return _render_console(
            "",
            Panel(
                "[bold green]🃏  21 BLACKJACK[/]\n\n"
                "[yellow]Bem-vindo ao jogo via TCP![/]\n\n"
                "Comandos:\n"
